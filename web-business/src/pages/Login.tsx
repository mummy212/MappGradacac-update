    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-900 to-emerald-700 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-1">Biznis Panel — Prijavite se</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1.5">Email adresa</label>
            <div className="relative">
              ...
              <input type="email" value={email} onChange={e => setEmail(e.target.value)}
                ...
                placeholder="biznis@email.com" required />
            </div>
          </div>
          <div>
        ...
        <p className="text-center text-xs text-slate-400 mt-6">
          Pristup samo za registrovane biznis vlasnike.<br />
          Kontaktirajte admina za kreaciju naloga.
        </p>
      </div>
    </div>
  )
